    ...
    <section class="categorias-container">
        ...
        <div class="container-search">
            <div class="col form-group icon">
                ...
                <input type="text" class="form-control search-input" data-id-table="tabla-categorias"
                    placeholder="Buscar categoría">
            </div>
            <div class="col btn-group">
                <button class="btn btn-info button-search" id="search-category" data-filter="all"
                    data-url="<?php echo url("/categorias/filtrar") ?>">
                    Todas
                </button>
                <button class="btn btn-info button-search active" id="all-categories" data-filter="categorys"
                    data-url="<?php echo url("/categorias/filtrar") ?>">
                    Principales
                </button>
                <button class="btn btn-info button-search" id="all-categories" data-filter="subcategorys"
                    data-url="<?php echo url("/categorias/filtrar") ?>">
                    Subcategorias
                </button>
            </div>
